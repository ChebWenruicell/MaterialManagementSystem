...
<div class="sidebar">
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-menu-item ${currentPage == '/user/list' ? 'active' : ''}">
        ...
        <li class="sidebar-menu-item ${currentPage == '/template/list' ? 'active' : ''}">
        ...
        <li class="sidebar-menu-item ${currentPage == '/material/list' ? 'active' : ''}">
